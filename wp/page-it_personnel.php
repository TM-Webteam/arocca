  ...
  <!-- <section class="plan">
    <div class="containers">
      ...
      <div class="flex jcC gap30 card">
        <div class="card__box">
          <ul class="card__box--be">
            <li>初めて自社採用を行う</li>
            <li>エンジニア採用に強い<br>求人媒体を使いたい</li>
          </ul>
          <div class="card__box--af">
            <ul>
              <li>Type活用プラン</li>
              <li>Green活用プラン</li>
            </ul>
        ...
        <div class="card__box">
          <ul class="card__box--be">
            <li>ダイレクトリクルーティングを行いたい</li>
            <li>エンジニアデータベースを<br>使用したい</li>
          </ul>
          <div class="card__box--af">
            <ul>
              <li>Forkwell活用プラン</li>
              <li>Findy活用プラン</li>
              <li>レバテックダイレクト<br>活用プラン</li>
            </ul>
          </div>
        </div>
        <div class="card__box">
          <ul class="card__box--be">
            <li>既存の採用手法と違う<br>アプローチがしたい</li>
          </ul>
          <div class="card__box--af">
            <ul>
              <li>採用リスティングプラン</li>
        ...
        <div class="card__box">
          <ul class="card__box--be">
            <li>社員の二次のつながりを<br>活用し、人材獲得したい</li>
          </ul>
          <div class="card__box--af ha">
            <ul>
              <li>リファラル2.0採用プラン</li>
            </ul>
          </div>
        ...
        <div class="card__box">
          <ul class="card__box--be">
            <li>既に媒体契約など採用活動を<br>行っており、事務業務のみを<br>アウトソーシングしたい</li>
          </ul>
          <div class="card__box--af ha">
            <ul>
              <li>ノンコア業務委託プラン</li>
