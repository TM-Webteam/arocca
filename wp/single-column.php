  ...
  <section class="">
    <div class="containers flex">
      ...
      <article class="main-conts single">
        ...
        <div class="single__time"><span class="time"><?php echo get_the_date(); ?></span></div>
          ...
          <div class="useful">
            ...
            <?php foreach (CFS()->get('whitepaper') as $val) : ?>
              ...
              <div class="item">
                ...
                <a href="<?php echo get_permalink($val); ?>" class="more bgG"><span>資料ダウンロード</span></a>
              </div>
