...
<aside class="side-nav">
  ...
  <div class="sticky">
    ...
    <a href="<?php echo esc_url( home_url( '/' ) ); ?>whitepaper/" class="bnr-catalog"><img src="<?php echo assets_path() ?>img/common/bnr-catalog.svg" alt="エンジニア採用のノウハウなど、採用業務の課題解決に役立つ！"></a>
  </div>
